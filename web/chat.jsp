<%@ page import="work.WebSocketTest" %>
...
<!--userno:发送消息人的编号-->
<%
    String userno= request.getParameter("uname");
%>
发送人:<div id=userno><%=userno%></div>
接收人：<input type="text" id="usernoto"><br>
<div>当前在线：</div>
<%
    for (String s : WebSocketTest.getMap().keySet()) {
       %>
<%=s%>
<%
    }
...
<script type="text/javascript">
    ...
    if ('WebSocket' in window) {
        websocket = new WebSocket("ws://localhost:8080/javaEE02_war_exploded/websocket/"+userno);
    }
    else {
